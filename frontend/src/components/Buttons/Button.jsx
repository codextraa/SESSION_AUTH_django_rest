...
export const OtpVerifyButton = () => {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className={baseStyles.otpVerifyButton}
    >
...
export const EmailVerificationRequestButton = () => {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className={baseStyles.resetPassButton}
    >
...
export const GoogleLoginButton = ({ disabled }) => {
  return <SocialLoginButton provider="google" disabled={disabled} />;
};

export const FacebookLoginButton = ({ disabled }) => {
  return <SocialLoginButton provider="facebook" disabled={disabled} />;
};

export const GitHubLoginButton = ({ disabled }) => {
  return <SocialLoginButton provider="github" disabled={disabled} />;
};
